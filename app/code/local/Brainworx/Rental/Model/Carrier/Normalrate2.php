...
/*
 * Class Brainworx_Rental_Model_Carrier_Normalrate2 based on Mage_Shipping_Model_Carrier_Tablerate
 */
class Brainworx_Rental_Model_Carrier_Normalrate2
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    {
        return Mage::getResourceModel('rental/carrier_normalrate2')->getRate($request);
    }
