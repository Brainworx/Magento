		...
		if ($data = $this->getRequest ()->getPost ()) {
			...
			try {
				...
				if (! $model->getEntityId ()) {
					...
					$link = $model->getUniqueLink();
					if(empty($link)){
						//Add autogenerated unique link
						$link = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB,true).'setZorgpuntCookie.php?zorgpuntid='.strtotime($model->getCreateDt()).'x'.$model->getEntityId();
						$model->setUniqueLink($link);
						$model->save();
					}
				}
