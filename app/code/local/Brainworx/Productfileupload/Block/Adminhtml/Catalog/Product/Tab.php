<?php  
class Brainworx_Productfileupload_Block_Adminhtml_Catalog_Product_Tab extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    /**
    ...
    public function getGuidesFiles()
    {
